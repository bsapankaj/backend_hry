...
<?php
    ...
    customer_name,f.is_cheque_collected
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="view_table" style="width:100%" border="1">
                                ...
                                <tr>
                                    <th colspan="3" style="text-align: center; background-color: #2980B9; color:white"><b>Feedback</b></th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                        <td>
                                            <b>Want to save as Standard LAT LONG : </b>
                                            <?php
                                            ?>
                                            <input type="checkbox" id="lat_long" name="lat_long" value="Bike">
                                        </td>
                                </tr>
