                        ...
                        <div class="panel-body">
                            <form action="" method="post">
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                        <div class="form-group col-md-3" id="pickSellrAdds">
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(theResponse) {
                    ...
                    var obj = theResponse;
                    if (obj.success) {
                        $("#pickSellrAdds").html('<option selected value="0">Select State</option>');
                        $.each(obj.data, function(i, v) {
                            $("#pickSellrAdds").append('<option value="">' + pickup_add + '</option>');
                        })
                    } else {
